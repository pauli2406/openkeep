...
const messages: Record<AppLanguage, Record<TranslationKey, string>> = {
  en: {
    ...
    "dashboard.loadingAtlas": "Loading…",
  ...
  de: {
    ...
    "root.menu.open": "Menü öffnen",
    "root.menu.close": "Menü schließen",
    ...
    "setup.description": "Richte das erste Owner-Konto für dein OpenKeep-Archiv ein",
    ...
    "settings.languagePreferencesDescription": "Wähle die App-Sprache und wie die KI verarbeiten und antworten soll.",
    ...
    "settings.failedToDeleteToken": "Token konnte nicht gelöscht werden",
    "settings.apiTokensTitle": "API-Token",
    "settings.apiTokensDescription": "Verwalte API-Token für den programmatischen Zugriff",
    ...
    "settings.createApiTokenDescription": "Erstelle ein neues Token für den API-Zugriff",
    "settings.name": "Name",
    ...
    "settings.taxonomyManagementDescription": "Pflege KI-generierte Bezeichnungen für Tags, Korrespondenzen und Dokumenttypen.",
    "settings.tags": "Tags",
    ...
    "settings.failedToDeleteTag": "Tag konnte nicht gelöscht werden",
    "settings.failedToDeleteCorrespondent": "Korrespondenz konnte nicht gelöscht werden",
    "settings.failedToDeleteDocumentType": "Dokumenttyp konnte nicht gelöscht werden",
    ...
    "settings.selectTarget": "Ziel auswählen",
    ...
    "settings.archivePortability": "Archiv-Portabilität",
    "settings.archivePortabilityDescription": "Exportiere Schnappschüsse, stelle sie wieder her und starte die Watch-Folder-Verarbeitung.",
    ...
    "settings.snapshotPlaceholder": "Exportiere einen Schnappschuss oder fuge hier einen für den Import ein",
    ...
    "settings.openDocument": "Dokument öffnen",
    "settings.inspectExtractedFields": "Extrahierte Felder prüfen",
    ...
    "settings.noExtractedFieldsYet": "Noch keine extrahierten Felder verfügbar.",
    "settings.keyFieldExtractionUnavailable": "Die Extraktion von Schlüsselfeldern ist für dieses Dokument noch nicht verfügbar.",
    "settings.foundValues": "Gefundene Werte",
    "settings.noKeyFieldsFound": "Noch keine Schlüsselfelder gefunden.",
    "settings.missingKeyFields": "Fehlende Schlüsselfelder",
    ...
    "settings.aiProvidersDescription": "Konfigurierte KI-Anbieter für Chat, Embeddings und Dokumentverarbeitung",
    ...
    "settings.noChatProviderConfigured": "Kein Chat-Anbieter konfiguriert. Setze `ACTIVE_CHAT_PROVIDER` mit passenden Zugangsdaten oder konfiguriere einen unterstützten Chat-Anbieter.",
    ...
    "settings.systemHealthDescription": "Serverstatus und Readiness-Prüfungen",
    "settings.checkingHealth": "Health wird geprüft...",
    "settings.unableToReachServer": "Server konnte nicht erreicht werden",
    "settings.server": "Server",
    "settings.runningReadinessChecks": "Readiness-Prüfungen laufen...",
    "settings.readinessChecks": "Readiness-Prüfungen",
    "settings.ok": "ok",
    ...
    "upload.titleOverrideOptional": "Titelüberschreibung (optional)",
    ...
    "dashboard.overdueDays": "T überfällig",
    ...
    "dashboard.loadingAtlas": "Wird geladen…",
    ...
    "dashboard.pendingReview": "Prüfung ausstehend",
    ...
    "documentDetail.backToDocuments": "Zurück zu Dokumenten",
    "documentDetail.notFound": "Dokument nicht gefunden",
    "documentDetail.returnToDocuments": "Zu Dokumenten zurückkehren",
    "documentDetail.documents": "Dokumente",
    "documentDetail.pendingReview": "Prüfung ausstehend",
    "documentDetail.reviewResolved": "Prüfung abgeschlossen",
    "documentDetail.preview": "Vorschau",
    "documentDetail.ocrText": "OCR-Text",
    "documentDetail.intelligence": "Intelligenz",
    "documentDetail.details": "Details",
    "documentDetail.history": "Verlauf",
    "documentDetail.previewUnavailable": "Vorschau nicht verfügbar",
    ...
    "documentDetail.noOcr": "Kein OCR-Text für dieses Dokument verfügbar.",
    "documentDetail.documentPreviewTitle": "Dokumentvorschau",
    "documentDetail.loadingContent": "Inhalt wird geladen...",
    "documentDetail.browserNoVideo": "Dein Browser unterstützt keine Videowiedergabe.",
    "documentDetail.browserNoAudio": "Dein Browser unterstützt keine Audiowiedergabe.",
    ...
    "documentDetail.noAuditEvents": "Für dieses Dokument wurden noch keine Audit-Ereignisse aufgezeichnet.",
    "documentDetail.metadata": "Metadaten",
    "documentDetail.edit": "Bearbeiten",
    "documentDetail.save": "Speichern",
    "documentDetail.failedToSaveChanges": "Änderungen konnten nicht gespeichert werden.",
    "documentDetail.savingWillLock": "Speichern sperrt",
    "documentDetail.lockedFieldsSticky": "Bereits gesperrte Felder bleiben überschrieben, bis du sie leerst.",
    "documentDetail.changedFieldsSticky": "Nur geänderte Felder werden zu dauerhaften manuellen Überschreibungen.",
    "documentDetail.title": "Titel",
    "documentDetail.selectCorrespondent": "Korrespondenz auswählen",
    "documentDetail.noCorrespondent": "Keine Korrespondenz",
    "documentDetail.addNewCorrespondent": "Neue Korrespondenz hinzufügen",
    "documentDetail.add": "Hinzufügen",
    ...
    "documentDetail.selectDocumentType": "Dokumenttyp auswählen",
    ...
    "documentDetail.noAgentIntelligence": "Für dieses Dokument ist noch keine Agentenintelligenz verfügbar.",
    "documentDetail.routing": "Routing",
    ...
    "documentDetail.taxonomyOptionsLoadFailed": "Taxonomieoptionen für manuelle Überschreibungen konnten nicht geladen werden.",
    "documentDetail.manualOverrides": "Manuelle Überschreibungen",
    ...
    "documentDetail.stickyOverrideHint": "Bearbeitungen an unterstützten Feldern erzeugen manuelle Überschreibungen, die eine Neuverarbeitung überstehen.",
    "documentDetail.clear": "Leeren",
    "documentDetail.failedToClearOverride": "Manuelle Überschreibung konnte nicht entfernt werden.",
    ...
    "documentDetail.resolveReview": "Prüfung abschließen",
    "documentDetail.requeue": "Neu einreihen",
    "documentDetail.failedToResolveReview": "Prüfung konnte nicht abgeschlossen werden.",
    ...
    "documentDetail.reprocessDialogDescription": "Wähle den OCR-Anbieter für die Neuverarbeitung aus.",
    "documentDetail.selectProvider": "Anbieter auswählen",
    "documentDetail.active": "aktiv",
    "documentDetail.fallback": "Fallback",
    "documentDetail.lastProcessedWith": "Zuletzt verarbeitet mit:",
    "documentDetail.cancel": "Abbrechen",
    "documentDetail.reprocessing": "Neuverarbeitung läuft...",
    "documentDetail.reprocess": "Neu verarbeiten",
    "documentDetail.deleteDialogTitle": "Dokument löschen",
    "documentDetail.deleteDialogDescription": "Dies löscht das Dokument, seine OCR-Ausgabe, Embeddings und generierten Dateien dauerhaft. Diese Aktion kann nicht rückgängig gemacht werden.",
    "documentDetail.deleting": "Wird gelöscht...",
    "documentDetail.deletePermanently": "Dauerhaft löschen",
    "documentDetail.dueDate": "Fälligkeitsdatum",
    ...
    "documentDetail.selectedTags": "Ausgewählte Tags",
    ...
    "documentDetail.savingWillLockAmountFields": "Speichern sperrt die geänderten Betragsfelder.",
    ...
    "documentDetail.allMatchingTagsSelected": "Alle passenden Tags sind bereits ausgewählt.",
    "documentDetail.noTagsMatchFilter": "Keine Tags entsprechen dem aktuellen Filter.",
    "documentDetail.noTagsAvailable": "Keine Tags verfügbar.",
