...
const DOCUMENT_TYPE_ALIASES: Record<string, string> = {
  ...
  portfoliovaluation: "Portfolio Statement",
  depotauszug: "Portfolio Statement",
  depotuebersicht: "Portfolio Statement",
  tradeconfirmation: "Trade Confirmation",
  transactionstatement: "Trade Confirmation",
  wertpapierabrechnung: "Trade Confirmation",
  taxstatement: "Tax Statement",
  jahressteuerbescheinigung: "Tax Statement",
  receipt: "Receipt",
  quittung: "Receipt",
  voucher: "Giftcard",
  gutschein: "Giftcard",
