...
const messages: Record<AppLanguage, Record<TranslationKey, string>> = {
  ...
  de: {
    ...
    "dashboard.overdueDays": "T uberfällig",
    ...
    "documentDetail.changedFieldsSticky": "Nur geänderte Felder werden zu dauerhaften manuellen Uberschreibungen.",
    ...
    "documentDetail.taxonomyOptionsLoadFailed": "Taxonomieoptionen für manuelle Uberschreibungen konnten nicht geladen werden.",
    ...
    "documentDetail.stickyOverrideHint": "Bearbeitungen an unterstützten Feldern erzeugen manuelle Uberschreibungen, die eine Neuverarbeitung uberstehen.",
