---
title: OpenKeep Documentation
description: Documentation hub for OpenKeep users, contributors, and operators.
slug: /
---

# OpenKeep Documentation

This directory is the main documentation hub for the current state of OpenKeep.

## Documentation Sets

### User Documentation

Start here if you are using OpenKeep to manage your archive.

- [Getting Started](./user/getting-started.md)
- [Core Workflows](./user/core-workflows.md)
...
Start here if you are contributing to or extending OpenKeep.
...
- [UI Visualization Plan](./ui-visualization-plan.md)

### Operational Documentation

Start here if you are deploying or operating OpenKeep.
...
### If you are using OpenKeep

1. [Getting Started](./user/getting-started.md)
2. [Core Workflows](./user/core-workflows.md)
...
1. [Technical Overview](./technical/README.md)
2. [Architecture Overview](./technical/architecture-overview.md)
